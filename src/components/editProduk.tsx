...
const EditProduk: React.FC<Props> = ({ visible, onPress,onPress2,id,onPress3 }) => {
  ...
  const UpdateProduk =() => {
    ...
    AsyncStorage.getItem('token').then(value => {
      ...
      myHeaders.append("Authorization", `Bearer ${value}`);
        ...
        fetch(`https://host.muhammadiyahexpo.com/api/update/${id}`, requestOptions)
  ...
  return (
    <Modal visible={visible} animationType={'slide'}>
      ...
      <View style={styles.conterInput}>
        ...
        />
        <TouchableOpacity onPress={UpdateProduk}>
