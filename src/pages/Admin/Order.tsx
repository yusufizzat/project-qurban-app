...
const OrderGroup = () => {
  ...
  useEffect(() => {
    AsyncStorage.getItem('token').then(value => {
      ...
      fetch("https://host.muhammadiyahexpo.com/api/tampilanadmin", requestOptions)
  ...
  return (
    ...
    <ScrollView>
      ...
      <View style={{width, backgroundColor:"#FFFFFF",borderTopEndRadius: 50,borderTopLeftRadius:50,paddingHorizontal:20}}>
            <Text style={styles.Title}>kurban user</Text>
    ...
    <DropdownPopup visible={popup} onPress={() => setPopup(false)} onPress2={handleClose} selectedId={selectedId}/>
    <ModalBerhasilPesan title='Status berhasli diganti' visible={berhasil} onPress={() => setBerhasil(false)}/>
    </>
  )
}
